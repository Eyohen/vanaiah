...
// <div>
// <p className='font-bold text-4xl max-w-[400px]'>Loan Amortization Calculator</p>
// <p className='text-xl max-w-[400px] mt-4'>Plan your loan repayments with detailed breakdowns, ensuring you stay in control of your finances.</p>
// </div>
...
//     <button className='bg-[#2B47FF] text-white text-xl px-4 py-2 rounded-md'>Salary Loan Calculator</button>
